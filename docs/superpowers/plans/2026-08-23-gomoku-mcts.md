...
def _as_int(value) -> int | None:
    ...
    try:
        ...
        # OverflowError matters: json.loads accepts a bare `Infinity` token,
        # and round(float("inf")) raises it.
